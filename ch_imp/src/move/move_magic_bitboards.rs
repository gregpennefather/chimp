...
const ROOK_MAGIC: [u64; 64] = [
    ...
    2918404027328762117,
    9369748920617467938,
    11541601048851384320,
    37718196702151296,
    18168330274275856,
    14987981758917542164,
    1225050571197677568,
    144150377816674304,
    729591936804982784,
    4688827758529283080,
    2251838469440768,
    16286142704381984772,
    612498431319085105,
    72198471114309888,
    36028934629883968,
    4756153187684061192,
...
const BISHOP_MAGIC: [u64; 64] = [
    ...
    576760094411326468,
    2386644091582021636,
    16141754500303044736,
    637748017246209,
    74326995039159424,
    3100184094183538820,
    2332873437447464064,
    16158919878442221824,
    22610512269279234,
    288235392746930176,
    4755801765124801568,
    9225753587781536000,
...
impl MagicTable {
    ...
    pub(crate) const fn empty() -> Self {
        Self {
            rook_table: [TableEntry { mask: 0, magic: 0}; 64],
            rook_attack_table: Vec::new(),
            bishop_table: [TableEntry { mask: 0, magic: 0}; 64],
            bishop_attack_table: Vec::new(),
        }
    }
}
